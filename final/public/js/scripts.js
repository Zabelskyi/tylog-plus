...
$(function() {
    ...
    var options = {
        center: {lat: 48.8534, lng: 2.3488}, // Paris, France
...
function addMarker(place)
{
    ...
    var marker = new MarkerWithLabel ({
        ...
        labelContent: place.postal_code + "," + place.place_name + "," + place.admin_name1 + "," + place.admin_name2,
        labelAnchor: new google.maps.Point(20, 0),
        labelClass: "label",
        labelStyle: {opacity: 0.75} //labelInBackground: false
    });
...
function configure()
{
    ...
    },
    {
        ...
        templates: {
            ...
            suggestion: _.template("<p><%- postal_code %>, <%- place_name %>,<%- admin_name1 %>,<%- admin_name2 %></p>")
        }
    });
